...
export const STAKING_PLANS = {
  ...
  "365": {
    ...
    features: ["365-day lock", "0.5% unstaking fee", "25% APY", "Maximum rewards"],
  },
} as const
...
export const STAKING_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "epochEnd", type: "uint256", indexed: false, internalType: "uint256" },
    ],
    anonymous: false,
  },
  {
    ...
    inputs: [{ name: "newLength", type: "uint256", indexed: false, internalType: "uint256" }],
    anonymous: false,
  },
  {
    type: "event",
  ...
  },
  {
    ...
    inputs: [
      { name: "durations", type: "uint256[]", indexed: false, internalType: "uint256[]" },
  ...
  },
  {
    ...
    inputs: [{ name: "newBps", type: "uint256", indexed: false, internalType: "uint256" }],
    anonymous: false,
  },
  {
    type: "event",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "id", type: "uint256", indexed: true, internalType: "uint256" },
      { name: "amount", type: "uint256", indexed: false, internalType: "uint256" },
      { name: "plan", type: "uint8", indexed: false, internalType: "enum Staking.Plan" },
